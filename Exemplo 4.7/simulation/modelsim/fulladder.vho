...
-- s[1]	=>  Location: PIN_25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \s~0_combout\ = \cin~combout\(1) $ (\a~combout\(1) $ (\b~combout\(1)))
...
-- Equation(s):
-- \cout~0_combout\ = (\cin~combout\(1) & ((\a~combout\(1)) # (\b~combout\(1)))) # (!\cin~combout\(1) & (\a~combout\(1) & \b~combout\(1)))
