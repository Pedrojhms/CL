...
-- Equation(s):
-- \finalmux|y[1]~2_combout\ = (\s~combout\(1) & ((\d2~combout\(1)) # ((\s~combout\(0))))) # (!\s~combout\(1) & (((\d0~combout\(1) & !\s~combout\(0)))))
...
-- Equation(s):
-- \finalmux|y[1]~3_combout\ = (\finalmux|y[1]~2_combout\ & (((\d3~combout\(1)) # (!\s~combout\(0))))) # (!\finalmux|y[1]~2_combout\ & (\d1~combout\(1) & ((\s~combout\(0)))))
...
-- Equation(s):
-- \finalmux|y[2]~5_combout\ = (\s~combout\(1) & ((\finalmux|y[2]~4_combout\ & ((\d3~combout\(2)))) # (!\finalmux|y[2]~4_combout\ & (\d2~combout\(2))))) # (!\s~combout\(1) & (\finalmux|y[2]~4_combout\))
...
-- Equation(s):
-- \finalmux|y[3]~7_combout\ = (\finalmux|y[3]~6_combout\ & ((\d3~combout\(3)) # ((!\s~combout\(0))))) # (!\finalmux|y[3]~6_combout\ & (((\d1~combout\(3) & \s~combout\(0)))))
